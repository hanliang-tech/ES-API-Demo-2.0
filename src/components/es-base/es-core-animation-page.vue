<template>
  <div id="animation-demo">
    <label>控制动画</label>
    <div class="toolbar">
      <text-button @onButtonClicked="togglePlaying" class="toolbar-btn button" :focusable="true" :requestFocus="true">
        <p v-if="playing" :duplicateParentState="true">暂停</p>
        <p v-else :duplicateParentState="true">播放</p>
      </text-button>
      <text-button @onButtonClicked="toggleDirection" class="toolbar-btn button" :focusable="true">
    ...
    <label>点赞笑脸动画:</label>
    <div class="toolbar">
      <text-button @onButtonClicked="voteUp" class="toolbar-btn button" :focusable="true">
        <p :duplicateParentState="true">点赞 👍</p>
      </text-button>
      <text-button @onButtonClicked="voteDown" class="toolbar-btn button" :focusable="true">
