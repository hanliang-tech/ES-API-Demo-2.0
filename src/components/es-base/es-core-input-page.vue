<template>
  <div ref="inputDemo" class="demo-input" @click="blurAllInput">
    ...
    <text-button class="input-button" :focusable="true" @focus="onfocus" @click="clearTextContent">
      <span>清空文本内容</span>
    </text-button>
    <text-button class="input-button" :focusable="true" @focus="onfocus" @click="focus">
      <span>Focus</span>
    </text-button>
    <text-button class="input-button" :focusable="true" @focus="onfocus" @click="blur">
      <span>Blur</span>
    </text-button>
    <label>数字:</label>
    <input
