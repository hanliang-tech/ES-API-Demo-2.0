<template>
  <div id="dialog-demo">
    ...
    <text-button class="dialog-demo-button-1" @onButtonClicked="clickView" :focusable="true" :requestFocus="true">
      ...
      <div class="dialog-demo-wrapper">
        ...
        <div class="fullscreen center row" @click="clickView">
          ...
          <div class="dialog-demo-close-btn center column" @click="stopPropagation">
            ...
            <text-button class="dialog-demo-button-1" @click="clickOpenSecond" :focusable="true">
