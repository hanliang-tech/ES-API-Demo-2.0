<template>
  <div id="shadow-demo">
    <div class="no-offset-shadow-demo-cube-android">
      <p class="no-offset-shadow-demo-content-android">没有偏移阴影样式</p>
    </div>
    <div class="offset-shadow-demo-cube-android">
...
#shadow-demo .offset-shadow-demo-cube-android {
  ...
  /*box-shadow-offset-x: 15px;*/
  /* it is supported by setting offset separately
