<template>
  <div id="demo-list">
    <div class="toolbar">
      <text-button class="toolbar-btn button" @click="scrollToNextPage" :focusable="true" :requestFocus="true">
        <p :duplicateParentState="true">翻到下一页</p>
      </text-button>
      <text-button class="toolbar-btn button" @click="scrollToTop" :focusable="true">
        <p :duplicateParentState="true">翻动到顶部</p>
      </text-button>
      <text-button class="toolbar-btn button" @click="scrollToBottom" :focusable="true">
